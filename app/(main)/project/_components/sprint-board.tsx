...
import { IssueStatusType, IssueType, SprintType } from "@/prisma/types";
import IssueCard from "@/components/shared/issue-card";
import IssueCreationDrawer from "./create-issues";
...
export default function SprintBoard({
  ...
  const {
    ...
    data: issues,
    setData: setIssues,
  } = useFetch<IssueType[], string>(getIssuesForSprint);

  const [filteredIssues, setFilteredIssues] = useState<IssueType[]>([]);

  const handleFilterChange = useCallback((newFilteredIssues: IssueType[]) => {
  ...
  const onDragEnd = async (result: DropResult) => {
    ...
    if (source.droppableId === destination.droppableId) {
      ...
      movedCard.status = destination.droppableId as IssueStatusType;
  ...
  return (
    <div className="flex flex-col">
      ...
      <IssueCreationDrawer
        ...
        status={selectedStatus as IssueStatusType}
        projectId={projectId}
